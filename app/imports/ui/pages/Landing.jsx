...
class Landing extends React.Component {
  render() {
    return (
      <div className="digits-landing-bg">
        <Grid id='landing-page' centered stackable container columns={3}>
          ...
          <Grid.Column textAlign='center'>
            ...
            <h3>For each contact, you an save their name, address, and phone number.</h3>
          </Grid.Column>
